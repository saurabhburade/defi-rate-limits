...
This repository uses the **Foundry flavor**. Contracts live in `packages/foundry/contracts/` and deployments live in `packages/foundry/script/`.
...
- OpenZeppelin is available in the Foundry workspace — no additional dependency installation needed
